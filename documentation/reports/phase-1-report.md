...
- [x] Define all roles and their permission matrices (`documentation/ROLES_AND_PERMISSIONS.md`)
- [x] Design full database schema (`documentation/DATABASE_SCHEMA.sql`)
- [x] Design API contract (`documentation/API_SPEC.md`)
- [x] Define WebSocket/SSE events (`documentation/WEBSOCKET_EVENTS.md`)
- [x] Document offline strategy (`documentation/OFFLINE_STRATEGY.md`)
- [x] Project structure documented (monorepo: `backend/`, `staff-app/`, `mobile-app/`)
- [x] `documentation/PROJECT_PROGRESS.md` updated
